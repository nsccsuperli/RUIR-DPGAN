...
parser.add_argument("--data_dir", type=str, default="samples/tencent/")
...
parser.add_argument("--model_path", type=str, default="checkpoints/dp_ganmodel.pth")
...
for path, img, im0s, vid_cap in dataset:
    ...
    img = img_sample.to(torch.device('cpu'))
